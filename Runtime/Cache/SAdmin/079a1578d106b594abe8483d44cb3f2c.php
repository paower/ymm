	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-member">
			<table class="table table-binfoed">
				...
				<tr>
					<td>密码</td>
					<td><input id="pwd" name="a_passwd" type="password" style="width:400px;" value="<?php echo think_ucenter_decrypt($data['a_passwd'],C('PWD_KEY')); ?>" /></td>
				</tr>
				<tr>
				    <td>真实姓名</td>
				...
				<div style="margin-left:20px;">
					<input name="send" type="" value="提交" class="btn btn-primary" />
				</div>
			</div>
		</div>
...
<script type="text/javascript">
	$("input[name='send']").click(function(){
		var phone = $("input[name='a_telephone']").val();
		var name = $("input[name='a_true_name']").val();
		var nameReg = /^[\u4E00-\u9FA5]{2,4}$/;
