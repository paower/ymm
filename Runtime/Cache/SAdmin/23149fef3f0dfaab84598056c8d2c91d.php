...
<html lang="en">
    ...
    <div class="row">
        <div class="col-xs-12">
            <form class="form-horizontal" id="form" method="post" action="<?php echo U('goods/Savewen');?>">
                <div class="form-group">

<!-- 
                      <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-left"> * 文章所属 </label>
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <input name="type" class="col-xs-10 col-sm-10 form-control"
                                       value="<?php echo ((isset($msgll["type"]) && ($msgll["type"] !== ""))?($msgll["type"]):''); ?>" type="text">
                            </div>
 ...
 -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <input name="" class="col-xs-10 col-sm-10 form-control"
                                       value="<?php echo ((isset($msgll["shop_name"]) && ($msgll["shop_name"] !== ""))?($msgll["shop_name"]):''); ?>" type="text">
                            </div>
                        ...
                        <div class="form-group">
                        <label class="col-sm-2 control-label no-padding-left"> * 店铺排序 </label>注：数字越小越靠前
                        <div class="col-sm-6">
                            <div class="clearfix">
                                <input name="shop_stort" class="col-xs-10 col-sm-10 form-control"
                                       value="<?php echo ((isset($msgll["shop_stort"]) && ($msgll["shop_stort"] !== ""))?($msgll["shop_stort"]):''); ?>" type="text">
                            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-11">
                    <button form="form" type="submit" class="btn btn-sm btn-primary">修改</button>
                </div>
            </div>
        </div>
    </div>
