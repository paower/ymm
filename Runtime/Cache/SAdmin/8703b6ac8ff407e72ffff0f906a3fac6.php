        ...
        <div class="col-xs-12">
            <div class="table-responsive">
                <div class="page-header">
                    <a class="btn btn-primary" href='<?php echo U("Settings/add");?>'>新增</a>
                </div>
                <table class="table table-striped table-bordered table-hover">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><img style="height:100px;" src="<?php echo ($v["pic"]); ?>"></td>

                            <td>
                                <a class="delete btn btn-xs btn-danger"
                                   href='<?php echo U("Settings/del11",array("id"=>$v["id"]));?>'>
                                    <i class="icon-trash bigger-120"></i>
                                </a>

                                <a class="btn btn-xs btn-info" href='<?php echo U("Settings/edit",array("id"=>$v["id"]));?>'>编辑</a>
