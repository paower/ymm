...
<html lang="en">
                ...
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-goods"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-name2">店铺手机号：</label>
                                <div class="col-sm-10">
                                    <input id="input-name2" class="form-control" type="text" placeholder="店铺手机号"
                                            value="<?php echo ((isset($goods["shop_phone"]) && ($goods["shop_phone"] !== ""))?($goods["shop_phone"]):''); ?>" name="shop_phone">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-name2">地图选择：</label>
                                <div class="col-sm-10">
                                    <div id="allmap" style="z-index: 999;"></div>
                                </div>
                            </div>
                            <input type="hidden" name="lng" value="<?php echo ($goods['lng']); ?>">
                            <input type="hidden" name="lat" value="<?php echo ($goods['lat']); ?>">
    ...
    <script type="text/javascript">
        ...
        var lng = "<?php echo ($goods["lng"]); ?>";
        var lat = "<?php echo ($goods["lat"]); ?>";
        if(!lng&&!lat){
            myCity.get(myFun); 
        }
        ...
        ZoomControl.prototype.initialize = function(map){
            ...
            div.innerHTML = '<div id="r-result" style="color:red;font-size: 18px; background:#fff;">搜索地址:<input type="text" id="suggestId" size="35" value="" style="width:180px;height:35px; font-size: 18px; "/></div><div id="searchResultPanel" style="border:1px solid #C0C0C0;width:180px;height:35px; display:none;"></div>';
