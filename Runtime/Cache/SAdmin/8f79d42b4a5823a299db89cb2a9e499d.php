...
<html lang="en">
    ...
    <div class="page-header">
        <h1>
            ...
            <button name="send" form="form-goods" type="button" style="float:right;" class="btn btn-sm btn-primary">提交
            </button>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="tab-general">
                            <div class="form-group required">
                                ...
                                <div class="col-sm-10">
                                    <input id="input-name2" class="form-control" type="text" placeholder="商品名称"
                                           value="<?php echo ((isset($goods["name"]) && ($goods["name"] !== ""))?($goods["name"]):''); ?>" name="name">
                                </div>
                            </div>

     <!--                        <div class="form-group required">
         <label class="col-sm-2 control-label" for="input-name2">商品描述：</label>
         <div class="col-sm-10">
             <input id="input-name2" class="form-control" type="text" placeholder="商品描述"
                    value="<?php echo ((isset($goods["s_desc"]) && ($goods["s_desc"] !== ""))?($goods["s_desc"]):''); ?>" name="s_desc">
         </div>
     </div>
      -->
                            <div class="form-group required">
              ...
              <select name="category">
                  ...
                  <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"
                      ...
                      ><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                            ...
                            <!-- <div class="form-group required"> -->
                                <!-- <label class="col-sm-2 control-label" for="input-meta-title2">现价：</label> -->
                                <!-- <div class="col-sm-10"> -->
                                    <!-- <input id="input-meta-title2" class="form-control" type="text" placeholder="现价" -->
                                           <!-- value="<?php echo ((isset($goods["price"]) && ($goods["price"] !== ""))?($goods["price"]):''); ?>" name="price"> -->
                                <!-- </div> -->
                            <!-- </div> -->

                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-meta-title2">邮费：</label>
                                <div class="col-sm-10">
                                    <input id="input-meta-title2" class="form-control" type="text" placeholder="0为包邮,到付请填写到付"
                                           value="<?php echo ((isset($goods["freight"]) && ($goods["freight"] !== ""))?($goods["freight"]):''); ?>" name="freight">
                                </div>
                            </div>

          <!--                   <div class="form-group required">
              <label class="col-sm-2 control-label" for="input-meta-title2">原价：</label>
              <div class="col-sm-10">
                  <input id="input-meta-title2" class="form-control" type="text" placeholder="原价"
                         value="<?php echo ((isset($goods["old_price"]) && ($goods["old_price"] !== ""))?($goods["old_price"]):''); ?>" name="old_price">
              </div>
          </div> -->
<!-- <div class="form-group required">
                       <label class="col-sm-2 control-label" for="input-meta-title2">运费：</label>
                       <div class="col-sm-10">
                           <input id="input-meta-title2" class="form-control" type="text" placeholder="运费"
                                  value="<?php echo ((isset($goods["freight"]) && ($goods["freight"] !== ""))?($goods["freight"]):''); ?>" name="freight">
                       </div>
                   </div> -->
                            <input type="text" value="<?php echo ($goods['jifen_type']); ?>" hidden name="alltypes" class="alltypes">
                            <?php $jifentype = explode(',' , $goods['jifen_type']); ?>
                          <!--   <div class="form-group jifentypes">
                              <label class="col-sm-2 control-label">积分类型：</label>
                              <div class="col-sm-10">
                                  <label class="radio-inline">
                                      <input type="checkbox" <?php  if(in_array('鸡场积分', $jifentype))echo checked ?>
                                      value="鸡场积分" name="jifen_type[]">鸡场积分</label>
                                  <label class="radio-inline">
                                      <input type="checkbox" <?php  if(in_array('果园积分', $jifentype))echo checked ?>
                                      value="果园积分" name="jifen_type[]">果园积分</label>
                                  <label class="radio-inline">
                                      <input type="checkbox" <?php  if(in_array('渔场积分', $jifentype))echo checked ?>
                                      value="渔场积分" name="jifen_type[]">渔场积分</label>
                                  <label class="radio-inline">
                              </div>
                          </div>
                           -->
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-meta-title2">赠送JM：</label>
                                <div class="col-sm-10">
                                    <input id="input-meta-title2" class="form-control" type="text" placeholder="赠送数量"
                                           value="<?php echo ((isset($goods["jifen_nums"]) && ($goods["jifen_nums"] !== ""))?($goods["jifen_nums"]):''); ?>" name="jifen_nums">
                                </div>
                            </div>
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-meta-title2">返还推荐人提成：</label>
                                <div class="col-sm-10">
                                    <input id="input-meta-title2" class="form-control" type="text" placeholder="返还数量"
                                           value="<?php echo ((isset($goods["return_balance"]) && ($goods["return_balance"] !== ""))?($goods["return_balance"]):''); ?>" name="return_balance">
                                </div>
                            </div>
<!-- 
                            <div class="form-group">
                                <label class="col-sm-2 control-label">消费积分使用比例：</label>
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input id="input-meta-title2" type="text" placeholder="%"
                                               value="<?php echo ((isset($goods["xiaofei_bili"]) && ($goods["xiaofei_bili"] !== ""))?($goods["xiaofei_bili"]):''); ?>" name="xiaofei_bili">%
                                    </label>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-2 control-label">商品参与三级比例比例：</label>
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input id="input-meta-title2" type="text" placeholder="%"
                                               value="<?php echo ((isset($goods["sanji_use"]) && ($goods["sanji_use"] !== ""))?($goods["sanji_use"]):''); ?>" name="sanji_use">%
                                    </label>
                                </div>
                            </div>
 -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_hot']) == "1"): ?>checked="checked"<?php endif; ?> value="1" name="hot">是</label>
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_hot']) == "0"): ?>checked="checked"<?php endif; ?> value="0" name="hot">否</label>
                                </div>
                            </div>
                       ...
                       <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_new']) == "1"): ?>checked="checked"<?php endif; ?>  value="1" name="new">是</label>
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_new']) == "0"): ?>checked="checked"<?php endif; ?> value="0" name="new">否</label>
                                </div>
                            </div>
                                                   <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_tuijian']) == "1"): ?>checked="checked"<?php endif; ?> value="1" name="tuijian">是</label>
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_tuijian']) == "0"): ?>checked="checked"<?php endif; ?> value="0" name="tuijian">否</label>
                                </div>
                            </div>
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_shangjia']) == "1"): ?>checked="checked"<?php endif; ?> value="1" name="shangjia">是</label>
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_shangjia']) == "0"): ?>checked="checked"<?php endif; ?> value="0" name="shangjia">否</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label">是否为返还提成：</label>
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['set_meal']) == "1"): ?>checked="checked"<?php endif; ?> value="1" name="set_meal">是</label>
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['set_meal']) == "0"): ?>checked="checked"<?php endif; ?> value="0" name="set_meal">否</label>
                                </div>
                            </div>
                            <!-- <div class="form-group">
                                <label class="col-sm-2 control-label">是否为升级会员商品：</label>
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_teshu']) == "1"): ?>checked="checked"<?php endif; ?> value="1" name="is_teshu">是</label>
                                    <label class="radio-inline">
                                        <input type="radio" <?php if(($goods['is_teshu']) == "0"): ?>checked="checked"<?php endif; ?> value="0" name="is_teshu">否</label>
                                </div>
                            </div> -->
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" <?php if(in_array('0',$goods['zhifu_pay'])): ?>checked="checked"<?php endif; ?> value="0" name="zhifu_pay[]">商家JM支付</label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" <?php if(in_array('2',$goods['zhifu_pay'])): ?>checked="checked"<?php endif; ?> value="2" name="zhifu_pay[]">消费JM支付</label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" <?php if(in_array('1',$goods['zhifu_pay'])): ?>checked="checked"<?php endif; ?> value="1" name="zhifu_pay[]">兑换卡支付</label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" <?php if(in_array('3',$goods['zhifu_pay'])): ?>checked="checked"<?php endif; ?> value="3" name="zhifu_pay[]">微信支付</label>
                                </div>
                            </div>
         ...
         <!--                    <div class="form-group">
             ...
             <div class="col-sm-10">
                 <label class="radio-inline">
                     <input type="radio"  <?php if(($goods['status']) == "1"): ?>checked="checked"<?php endif; ?> value="1" name="status">启用</label>
                 <label class="radio-inline">
                     <input type="radio" <?php if(($goods['status']) == "0"): ?>checked="checked"<?php endif; ?>  value="0" name="status">停用</label>
             </div>
         </div> -->

       <!--                      <div class="form-group required">
           <label class="col-sm-2 control-label" for="input-meta-title2">发货城市：</label>
           <div class="col-sm-2">
               <input id="input-meta-title2" class="form-control" type="text" placeholder="发货城市"
                      value="<?php echo ((isset($goods["address"]) && ($goods["address"] !== ""))?($goods["address"]):''); ?>" name="address">
           </div>
       </div> -->
<!-- 
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-meta-title2">销售量：</label>
                                <div class="col-sm-2">
                                    <input id="input-meta-title2" class="form-control" type="text" placeholder="发货城市"
                                           value="<?php echo ((isset($goods["buy_num"]) && ($goods["buy_num"] !== ""))?($goods["buy_num"]):''); ?>" name="buy_num">
                                </div>
                            </div>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-meta-title2">点赞量：</label>
                                <div class="col-sm-10">
                                    <?php echo ((isset($goods["praise_num"]) && ($goods["praise_num"] !== ""))?($goods["praise_num"]):''); ?>
                                </div>
                            </div>
 -->
                            ...
                            <div class="form-group required">
                                ...
                                <div class="col-sm-2">
                                    <input id="input-meta-title2" class="form-control" type="text" placeholder="排序"
                                           value="<?php echo ((isset($goods["is_sort"]) && ($goods["is_sort"] !== ""))?($goods["is_sort"]):''); ?>" name="sort">
                                </div>
                            </div>
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-meta-title2">添加时间：</label>
                                <div class="col-sm-10">
                                    <?php echo (date("Y-m-d H:i:s",$goods["ctime"])); ?>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-image">
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-image">
                                    <span title="" data-toggle="tooltip" data-original-title="上传200x200的图片">封面图：</span>
                                </label>

                                <div class="col-sm-10 thumb">
                                    <a href="#" data-toggle="pic" class="img-thumbnail">
                                        <img osctype="image" height="200" width="200"
                                        <?php if($goods['pic']): ?>src="<?php echo ($goods["pic"]); ?>"
                                            <?php else: ?>
                                            src="/Common/image/no_image_100x100.jpg"<?php endif; ?>
                                        />
                                    </a>
                                    <input osctype="image_input" type="hidden" name="pic"
                                           value="<?php echo ((isset($goods["pic"]) && ($goods["pic"] !== ""))?($goods["pic"]):''); ?>" id="pic"/>
                                </div>
                            </div>
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-image">
                                    <span title="" data-toggle="tooltip" data-original-title="上传800x800的图片">图片1：</span>
                                </label>

                                <div class="col-sm-10 thumb">
                                    <a href="#" data-toggle="image" class="img-thumbnail">
                                        <img osctype="image"  height="200" width="300"
                                        <?php if($goods['pic1']): ?>src="<?php echo ($goods["pic1"]); ?>"
                                            <?php else: ?>
                                            src="/Common/image/no_image_100x100.jpg"<?php endif; ?>
                                        />
                                    </a>
                                    <input osctype="image_input" type="hidden" name="pic1"
                                           value="<?php echo ((isset($goods["pic1"]) && ($goods["pic1"] !== ""))?($goods["pic1"]):''); ?>" id="pic1"/>
                                </div>
                            </div>

                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-image">
                                    <span title="" data-toggle="tooltip" data-original-title="上传750x550的图片">图片2：</span>
                                </label>

                                <div class="col-sm-10 thumb">
                                    <a href="#" data-toggle="image" class="img-thumbnail">
                                        <img osctype="image"  height="200" width="300"
                                        <?php if($goods['pic2']): ?>src="<?php echo ($goods["pic2"]); ?>"
                                            <?php else: ?>
                                            src="/Common/image/no_image_100x100.jpg"<?php endif; ?>
                                        />
                                    </a>
                                    <input osctype="image_input" type="hidden" name="pic2"
                                           value="<?php echo ((isset($goods["pic2"]) && ($goods["pic2"] !== ""))?($goods["pic2"]):''); ?>" id="pic2"/>
                                </div>
                            </div>

                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-image">
                                    <span title="" data-toggle="tooltip" data-original-title="上传750x550的图片">图片3：</span>
                                </label>

                                <div class="col-sm-10 thumb">
                                    <a href="#" data-toggle="image" class="img-thumbnail">
                                        <img osctype="image"  height="200" width="300"
                                        <?php if($goods['pic3']): ?>src="<?php echo ($goods["pic3"]); ?>"
                                            <?php else: ?>
                                            src="/Common/image/no_image_100x100.jpg"<?php endif; ?>
                                        />
                                    </a>
                                    <input osctype="image_input" type="hidden" name="pic3"
                                           value="<?php echo ((isset($goods["pic3"]) && ($goods["pic3"] !== ""))?($goods["pic3"]):''); ?>" id="pic3"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-image">
                                    <span title="" data-toggle="tooltip" data-original-title="上传750x550的图片">图片4：</span>
                                </label>

                                <div class="col-sm-10 thumb">
                                    <a href="#" data-toggle="image" class="img-thumbnail">
                                        <img osctype="image"   height="200" width="300"
                                        <?php if($goods['pic4']): ?>src="<?php echo ($goods["pic4"]); ?>"
                                            <?php else: ?>
                                            src="/Common/image/no_image_100x100.jpg"<?php endif; ?>
                                        />
                                    </a>
                                    <input osctype="image_input" type="hidden" name="pic4"
                                           value="<?php echo ((isset($goods["pic4"]) && ($goods["pic4"] !== ""))?($goods["pic4"]):''); ?>" id="pic4"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group required">
                                <label class="col-sm-2 control-label" for="input-image">
                                    <span title="" data-toggle="tooltip" data-original-title="上传750x550的图片">图片5：</span>
                                </label>

                                <div class="col-sm-10 thumb">
                                    <a href="#" data-toggle="image" class="img-thumbnail">
                                        <img osctype="image" height="200" width="300"
                                        <?php if($goods['pic5']): ?>src="<?php echo ($goods["pic5"]); ?>"
                                            <?php else: ?>
                                            src="/Common/image/no_image_100x100.jpg"<?php endif; ?>
                                        />
                                    </a>
                                    <input osctype="image_input" type="hidden" name="pic5"
                                           value="<?php echo ((isset($goods["pic5"]) && ($goods["pic5"] !== ""))?($goods["pic5"]):''); ?>" id="pic5"/>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-params">
                           ...
                           <div class="form-group required">
                            ...
                            <div class="cate_box" style="margin-left: 225px;">
                                参数：
                                <div class="cate" style="width: 100%;height: 60px;margin-bottom: 20px;">
                                    型号<input type="text" name="cate[]" value="<?php echo ($goods['parameter'][0]['type']); ?>"><br>
                                    价格<input type="text" name="price[]" value="<?php echo ($goods['parameter'][0]['price']); ?>"><br>
                                    库存<input type="text" name="kucun[]" value="<?php echo ($goods['parameter'][0]['kucun']); ?>"><br>
                                </div>
                                <?php  $num = count($goods['parameter']); if($num==0){ $num=1; } for($i=1;$i<$num;$i++){ ?>
                                <div class="cate2" style="width: 100%;height: 60px;margin-bottom: 20px;">
                                    型号<input type="text" name="cate[]" value="<?php echo ($goods['parameter'][$i]['type']); ?>"><br>
                                    价格<input type="text" name="price[]" value="<?php echo ($goods['parameter'][$i]['price']); ?>"><br>
                                    库存<input type="text" name="kucun[]" value="<?php echo ($goods['parameter'][$i]['kucun']); ?>"><br>
                                </div>
                                <?php
 } ?>
    ...
    <script type="text/javascript">
        $('#add_cate').click(function(){
            $('.cate').after('<div class="cate2" style="width: 100%;height:60px;margin-bottom:20px;">型号<input type="text" name="cate[]"><br>价格<input type="text" name="price[]"><br>库存<input type="text" name="kucun[]"><br></div>');
        });
