...
<form action="<?php echo U('Goods/cateUpdate');?>" method="POST" id="cateForm" enctype="multipart/form-data">
...
<div class="form-group required">
	...
	<div class="col-sm-3">
	    <input id="input-name2" class="form-control" type="text" placeholder="分类标题"
	           value="<?php echo ($cate['name']); ?>" name="name">
	</div>
</div>
<div style="clear: both;"></div>

<div class="form-group required" style="margin: 10px 0px;">
		<label class="col-sm-2 control-label" for="input-name2">返还商家余额折扣：<br/>(商家所获得余额)</label>
		<div class="input-group" style="width: 200px;padding-left: 10px;">
				<input id="input-name2" class="form-control" type="text" placeholder="余额折扣" value="<?php echo ($cate['cangku_ratio']*100); ?>" name="cangku_ratio">
				<span class="input-group-addon">%</span>
		</div>
	</div>
	<div style="clear: both;"></div>
	<div class="form-group required" style="margin: 10px 0px;">
		<label class="col-sm-2 control-label" for="input-name2">返还用户积分折扣：<br/>(用户所获得积分)</label>
		<div class="input-group" style="width: 200px;padding-left: 10px;">
			<input id="input-name2" class="form-control" type="text" placeholder="积分折扣" value="<?php echo ($cate['fengmi_ratio']*100); ?>" name="fengmi_ratio">
			<span class="input-group-addon">%</span>
	...
	<div style="clear: both;"></div>
	<div class="form-group required" style="margin: 10px 0px;">
		<label class="col-sm-2 control-label" for="input-name2">自动收货时间：<br/>(默认为零则为7天后自动收货)</label>
		<div class="input-group" style="width: 200px;padding-left: 10px;">
			<input id="input-name2" class="form-control" type="text" placeholder="自动收货时间" value="<?php echo ($cate['goods_end']/3600); ?>" name="goods_end">
...
<div style="clear: both;"></div>
<div class="form-group required">
	<label class="col-sm-2 control-label" for="input-name2">图片上传：</label>
	<div class="col-sm-3">
	    <input id="input-name2" class="form-control" accept="image/png,image/gif" type="file" placeholder="分类标题" value="<?php echo ($cate['pic']); ?>" name="pic">
	</div>
</div>

<div style="clear: both;"></div>
<div class="form-group required" style="margin:10px 0px;">
	<label class="col-sm-2 control-label" for="input-name2">&nbsp;</label>
	<div class="col-sm-3">
		<img src="<?php echo ($cate['pic']); ?>" width="100" height="100" />
	</div>
</div>
...
$(function(){
	$("#addCate").click(function(){
		...
		cangku_ratio = $("input[name='cangku_ratio']").val();
		fengmi_ratio = $("input[name='fengmi_ratio']").val();
