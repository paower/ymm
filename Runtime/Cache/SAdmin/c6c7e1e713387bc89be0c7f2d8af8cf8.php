...
<table class="table table-striped table-bordered table-hover search-form">
	<thead>
		...
		<th>    				
			<select name="status">
				<option value="10" <?php echo ($f_status==10?'selected':''); ?>>-选择状态-</option>
				<option value="0" <?php echo ($f_status==0?'selected':''); ?>>未付款</option>
				<option value="1" <?php echo ($f_status==1?'selected':''); ?>>待发货</option>
				<option value="2" <?php echo ($f_status==2?'selected':''); ?> >已发货</option>
				<option value="3" <?php echo ($f_status==3?'selected':''); ?>>交易完成</option>

			</select>
		</th>
		<th>    				
			<select name="type">
				<option value="0" <?php echo ($type==0?'selected':''); ?>>后台店铺</option>
				<option value="1" <?php echo ($type==1?'selected':''); ?>>入驻店铺</option>
