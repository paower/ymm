            ...
            <div class="col-sm-10">
               ...
               <div class="col-sm-10">
                   <select name="category">
                       ...
                       <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                   </select>
               </div>
           </div>

                            <!-- <div class="form-group required"> -->
                                <!-- <label class="col-sm-2 control-label" for="input-meta-title2">售价：</label> -->
                                <!-- <div class="col-sm-10"> -->
                                    <!-- <input id="input-meta-title2" class="form-control" type="text" placeholder="售价" -->
                  ...
                  <input id="input-meta-title2" type="text" placeholder="%"
                         value="<?php echo ((isset($goods["sanji_use"]) && ($goods["sanji_use"] !== ""))?($goods["sanji_use"]):''); ?>" name="sanji_use">%
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" checked="checked" value="1" name="hot">是</label>
                                    <label class="radio-inline">
                                        <input type="radio" value="0" name="hot">否</label>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio"  checked="checked" value="1" name="new">是</label>
                                    <label class="radio-inline">
                                        <input type="radio"  value="0" name="new">否</label>
                                </div>
                            </div>
                                                   <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" checked="checked" value="1" name="tuijian">是</label>
                                    <label class="radio-inline">
                                        <input type="radio"  value="0" name="tuijian">否</label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="radio-inline">
                                        <input type="radio" value="1" name="set_meal">是</label>
                                    <label class="radio-inline">
                                        <input type="radio"  checked="checked" value="0" name="set_meal">否</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label class="checkbox-inline">
                                        <input type="checkbox" value="0" name="zhifu_pay[]">商家JM支付</label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" value="2" name="zhifu_pay[]">消费JM支付</label>
                                    <label class="checkbox-inline">
                                        <input type="checkbox" value="1" name="zhifu_pay[]">兑换卡支付</label>
                           ...
                           <div class="form-group required">
                            ...
                            <div class="cate_box" style="margin-left: 225px;">
                                <div class="cate" style="width: 100%;height: 60px;margin-bottom: 20px;">
                                    型号<input type="text" name="cate[]" value="<?php echo ($produce_dets['parameter'][0]['type']); ?>"><br>
                                    价格<input type="text" name="price[]" value="<?php echo ($produce_dets['parameter'][0]['price']); ?>"><br>
                                    库存<input type="text" name="kucun[]" value="<?php echo ($produce_dets['parameter'][0]['kucun']); ?>"><br>
                                </div>
