...
<html lang="en">
	...
	<div class="row">
		<div class="col-xs-12">
			<form class="form-horizontal" id="form" method="post" action="<?php echo U('Settings/saveReward');?>">
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-left" style="font-weight: bold;">买家</label>
					<div class="col-sm-10">
						<div class="clearfix">
						</div>
					</div>
				...
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-left">直推奖励(%)：</label>
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="buy_firstReward" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($buy_firstReward * 100); ?>" type="number">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-left">间推奖励(%)：</label>
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="buy_secondReward" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($buy_secondReward * 100); ?>" type="number">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-left">奖励进入充值(%)：</label>
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="buyReward_to_rechar" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($buyReward_to_rechar * 100); ?>" type="number">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-left">奖励进入商家JM(%)：</label>
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="buyReward_to_shopEta" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($buyReward_to_shopEta * 100); ?>" type="number">
						</div>
					</div>
				</div>
				
				<div class="form-group">
					<label class="col-sm-2 control-label no-padding-left" style="font-weight: bold;">卖家</label>
					<div class="col-sm-10">
						<div class="clearfix">
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="sell_firstReward" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($sell_firstReward * 100); ?>" type="number">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="sell_secondReward" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($sell_secondReward * 100); ?>" type="number">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="sellReward_to_rechar" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($sellReward_to_rechar * 100); ?>" type="number">
						</div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
						<div class="clearfix">
							<input name="sellReward_to_shopEta" class="col-xs-10 col-sm-10 form-control" value="<?php echo ($sellReward_to_shopEta * 100); ?>" type="number">
						</div>
					</div>
				</div>
			</form>
