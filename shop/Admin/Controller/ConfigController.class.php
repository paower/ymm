...
//奖励设置
    public function group4()
    {
      ...
      $level2_rechar3_firstReward =  M('config')->where(array('name'=>'level2_rechar3_firstReward'))->getField('value');
      $level2_rechar3_secondReward =  M('config')->where(array('name'=>'level2_rechar3_secondReward'))->getField('value');
      $level2_reward3_to_rechar =  M('config')->where(array('name'=>'level2_reward3_to_rechar'))->getField('value');
      $level2_reward3_to_shopEta =  M('config')->where(array('name'=>'level2_reward3_to_shopEta'))->getField('value');
      ...
      $level3_rechar3_firstReward =  M('config')->where(array('name'=>'level3_rechar3_firstReward'))->getField('value');
      $level3_rechar3_secondReward =  M('config')->where(array('name'=>'level3_rechar3_secondReward'))->getField('value');
      $level3_reward3_to_rechar =  M('config')->where(array('name'=>'level3_reward3_to_rechar'))->getField('value');
      $level3_reward3_to_shopEta =  M('config')->where(array('name'=>'level3_reward3_to_shopEta'))->getField('value');
      ...
      $level4_rechar3_firstReward =  M('config')->where(array('name'=>'level4_rechar3_firstReward'))->getField('value');
      $level4_rechar3_secondReward =  M('config')->where(array('name'=>'level4_rechar3_secondReward'))->getField('value');
      $level4_reward3_to_rechar =  M('config')->where(array('name'=>'level4_reward3_to_rechar'))->getField('value');
      $level4_reward3_to_shopEta =  M('config')->where(array('name'=>'level4_reward3_to_shopEta'))->getField('value');
      ...
      $level5_rechar3_firstReward =  M('config')->where(array('name'=>'level5_rechar3_firstReward'))->getField('value');
      $level5_rechar3_secondReward =  M('config')->where(array('name'=>'level5_rechar3_secondReward'))->getField('value');
      $level5_reward3_to_rechar =  M('config')->where(array('name'=>'level5_reward3_to_rechar'))->getField('value');
      $level5_reward3_to_shopEta =  M('config')->where(array('name'=>'level5_reward3_to_shopEta'))->getField('value');

      //六级
      $level6_rechar_firstReward =  M('config')->where(array('name'=>'level6_rechar_firstReward'))->getField('value');
      $level6_rechar_secondReward =  M('config')->where(array('name'=>'level6_rechar_secondReward'))->getField('value');
      $level6_reward_to_rechar =  M('config')->where(array('name'=>'level6_reward_to_rechar'))->getField('value');
      $level6_reward_to_shopEta =  M('config')->where(array('name'=>'level6_reward_to_shopEta'))->getField('value');

      $level6_rechar2_firstReward =  M('config')->where(array('name'=>'level6_rechar2_firstReward'))->getField('value');
      $level6_rechar2_secondReward =  M('config')->where(array('name'=>'level6_rechar2_secondReward'))->getField('value');
      $level6_reward2_to_rechar =  M('config')->where(array('name'=>'level6_reward2_to_rechar'))->getField('value');
      $level6_reward2_to_shopEta =  M('config')->where(array('name'=>'level6_reward2_to_shopEta'))->getField('value');

      $level6_rechar3_firstReward =  M('config')->where(array('name'=>'level6_rechar3_firstReward'))->getField('value');
      $level6_rechar3_secondReward =  M('config')->where(array('name'=>'level6_rechar3_secondReward'))->getField('value');
      $level6_reward3_to_rechar =  M('config')->where(array('name'=>'level6_reward3_to_rechar'))->getField('value');
      $level6_reward3_to_shopEta =  M('config')->where(array('name'=>'level6_reward3_to_shopEta'))->getField('value');

      //七级
      $level7_rechar_firstReward =  M('config')->where(array('name'=>'level7_rechar_firstReward'))->getField('value');
      $level7_rechar_secondReward =  M('config')->where(array('name'=>'level7_rechar_secondReward'))->getField('value');
      $level7_reward_to_rechar =  M('config')->where(array('name'=>'level7_reward_to_rechar'))->getField('value');
      $level7_reward_to_shopEta =  M('config')->where(array('name'=>'level7_reward_to_shopEta'))->getField('value');

      $level7_rechar2_firstReward =  M('config')->where(array('name'=>'level7_rechar2_firstReward'))->getField('value');
      $level7_rechar2_secondReward =  M('config')->where(array('name'=>'level7_rechar2_secondReward'))->getField('value');
      $level7_reward2_to_rechar =  M('config')->where(array('name'=>'level7_reward2_to_rechar'))->getField('value');
      $level7_reward2_to_shopEta =  M('config')->where(array('name'=>'level7_reward2_to_shopEta'))->getField('value');

      $level7_rechar3_firstReward =  M('config')->where(array('name'=>'level7_rechar3_firstReward'))->getField('value');
      $level7_rechar3_secondReward =  M('config')->where(array('name'=>'level7_rechar3_secondReward'))->getField('value');
      $level7_reward3_to_rechar =  M('config')->where(array('name'=>'level7_reward3_to_rechar'))->getField('value');
      $level7_reward3_to_shopEta =  M('config')->where(array('name'=>'level7_reward3_to_shopEta'))->getField('value');

      //八级
      $level8_rechar_firstReward =  M('config')->where(array('name'=>'level8_rechar_firstReward'))->getField('value');
      $level8_rechar_secondReward =  M('config')->where(array('name'=>'level8_rechar_secondReward'))->getField('value');
      $level8_reward_to_rechar =  M('config')->where(array('name'=>'level8_reward_to_rechar'))->getField('value');
      $level8_reward_to_shopEta =  M('config')->where(array('name'=>'level8_reward_to_shopEta'))->getField('value');

      $level8_rechar2_firstReward =  M('config')->where(array('name'=>'level8_rechar2_firstReward'))->getField('value');
      $level8_rechar2_secondReward =  M('config')->where(array('name'=>'level8_rechar2_secondReward'))->getField('value');
      $level8_reward2_to_rechar =  M('config')->where(array('name'=>'level8_reward2_to_rechar'))->getField('value');
      $level8_reward2_to_shopEta =  M('config')->where(array('name'=>'level8_reward2_to_shopEta'))->getField('value');

      $level8_rechar3_firstReward =  M('config')->where(array('name'=>'level8_rechar3_firstReward'))->getField('value');
      $level8_rechar3_secondReward =  M('config')->where(array('name'=>'level8_rechar3_secondReward'))->getField('value');
      $level8_reward3_to_rechar =  M('config')->where(array('name'=>'level8_reward3_to_rechar'))->getField('value');
      $level8_reward3_to_shopEta =  M('config')->where(array('name'=>'level8_reward3_to_shopEta'))->getField('value');

      //九级
      $level9_rechar_firstReward =  M('config')->where(array('name'=>'level9_rechar_firstReward'))->getField('value');
      $level9_rechar_secondReward =  M('config')->where(array('name'=>'level9_rechar_secondReward'))->getField('value');
      $level9_reward_to_rechar =  M('config')->where(array('name'=>'level9_reward_to_rechar'))->getField('value');
      $level9_reward_to_shopEta =  M('config')->where(array('name'=>'level9_reward_to_shopEta'))->getField('value');

      $level9_rechar2_firstReward =  M('config')->where(array('name'=>'level9_rechar2_firstReward'))->getField('value');
      $level9_rechar2_secondReward =  M('config')->where(array('name'=>'level9_rechar2_secondReward'))->getField('value');
      $level9_reward2_to_rechar =  M('config')->where(array('name'=>'level9_reward2_to_rechar'))->getField('value');
      $level9_reward2_to_shopEta =  M('config')->where(array('name'=>'level9_reward2_to_shopEta'))->getField('value');

      $level9_rechar3_firstReward =  M('config')->where(array('name'=>'level9_rechar3_firstReward'))->getField('value');
      $level9_rechar3_secondReward =  M('config')->where(array('name'=>'level9_rechar3_secondReward'))->getField('value');
      $level9_reward3_to_rechar =  M('config')->where(array('name'=>'level9_reward3_to_rechar'))->getField('value');
      $level9_reward3_to_shopEta =  M('config')->where(array('name'=>'level9_reward3_to_shopEta'))->getField('value');
      ...
      //等级名称
      $v1_name = M('vip_level')->where("level = 1")->getField('name');
      $v2_name = M('vip_level')->where("level = 2")->getField('name');
      $v3_name = M('vip_level')->where("level = 3")->getField('name');
      $v4_name = M('vip_level')->where("level = 4")->getField('name');
      $v5_name = M('vip_level')->where("level = 5")->getField('name');
      $v6_name = M('vip_level')->where("level = 6")->getField('name');
      $v7_name = M('vip_level')->where("level = 7")->getField('name');
      $v8_name = M('vip_level')->where("level = 8")->getField('name');
      $v9_name = M('vip_level')->where("level = 9")->getField('name');

      $this->assign('v1_name',$v1_name);
      $this->assign('v2_name',$v2_name);
      $this->assign('v3_name',$v3_name);
      $this->assign('v4_name',$v4_name);
      $this->assign('v5_name',$v5_name);
      $this->assign('v6_name',$v6_name);
      $this->assign('v7_name',$v7_name);
      $this->assign('v8_name',$v8_name);
      $this->assign('v9_name',$v9_name);
      ...
      $cash2_ratio = M('config')->where(array('name'=>'cash2_ratio'))->getField('value');
      ...
      $this->assign('cash2_ratio',$cash2_ratio);
    ...
    $this->assign('rechar3_firstReward',$rechar3_firstReward);
    $this->assign('rechar3_secondReward',$rechar3_secondReward);
    $this->assign('reward3_to_rechar',$reward3_to_rechar);
    $this->assign('reward3_to_shopEta',$reward3_to_shopEta);
    ...
    $this->assign('level2_rechar3_firstReward',$level2_rechar3_firstReward);
    $this->assign('level2_rechar3_secondReward',$level2_rechar3_secondReward);
    $this->assign('level2_reward3_to_rechar',$level2_reward3_to_rechar);
    $this->assign('level2_reward3_to_shopEta',$level2_reward3_to_shopEta);
    ...
    $this->assign('level3_rechar3_firstReward',$level3_rechar3_firstReward);
    $this->assign('level3_rechar3_secondReward',$level3_rechar3_secondReward);
    $this->assign('level3_reward3_to_rechar',$level3_reward3_to_rechar);
    $this->assign('level3_reward3_to_shopEta',$level3_reward3_to_shopEta);
    ...
    $this->assign('level4_rechar3_firstReward',$level4_rechar3_firstReward);
    $this->assign('level4_rechar3_secondReward',$level4_rechar3_secondReward);
    $this->assign('level4_reward3_to_rechar',$level4_reward3_to_rechar);
    $this->assign('level4_reward3_to_shopEta',$level4_reward3_to_shopEta);
    ...
    $this->assign('level5_rechar3_firstReward',$level5_rechar3_firstReward);
    $this->assign('level5_rechar3_secondReward',$level5_rechar3_secondReward);
    $this->assign('level5_reward3_to_rechar',$level5_reward3_to_rechar);
    $this->assign('level5_reward3_to_shopEta',$level5_reward3_to_shopEta);

    //六级
    $this->assign('level6_rechar_firstReward',$level6_rechar_firstReward);
    $this->assign('level6_rechar_secondReward',$level6_rechar_secondReward);
    $this->assign('level6_reward_to_rechar',$level6_reward_to_rechar);
    $this->assign('level6_reward_to_shopEta',$level6_reward_to_shopEta);

    $this->assign('level6_rechar2_firstReward',$level6_rechar2_firstReward);
    $this->assign('level6_rechar2_secondReward',$level6_rechar2_secondReward);
    $this->assign('level6_reward2_to_rechar',$level6_reward2_to_rechar);
    $this->assign('level6_reward2_to_shopEta',$level6_reward2_to_shopEta);

    $this->assign('level6_rechar3_firstReward',$level6_rechar3_firstReward);
    $this->assign('level6_rechar3_secondReward',$level6_rechar3_secondReward);
    $this->assign('level6_reward3_to_rechar',$level6_reward3_to_rechar);
    $this->assign('level6_reward3_to_shopEta',$level6_reward3_to_shopEta);

    //七级
    $this->assign('level7_rechar_firstReward',$level7_rechar_firstReward);
    $this->assign('level7_rechar_secondReward',$level7_rechar_secondReward);
    $this->assign('level7_reward_to_rechar',$level7_reward_to_rechar);
    $this->assign('level7_reward_to_shopEta',$level7_reward_to_shopEta);

    $this->assign('level7_rechar2_firstReward',$level7_rechar2_firstReward);
    $this->assign('level7_rechar2_secondReward',$level7_rechar2_secondReward);
    $this->assign('level7_reward2_to_rechar',$level7_reward2_to_rechar);
    $this->assign('level7_reward2_to_shopEta',$level7_reward2_to_shopEta);

    $this->assign('level7_rechar3_firstReward',$level7_rechar3_firstReward);
    $this->assign('level7_rechar3_secondReward',$level7_rechar3_secondReward);
    $this->assign('level7_reward3_to_rechar',$level7_reward3_to_rechar);
    $this->assign('level7_reward3_to_shopEta',$level7_reward3_to_shopEta);

    //八级
    $this->assign('level8_rechar_firstReward',$level8_rechar_firstReward);
    $this->assign('level8_rechar_secondReward',$level8_rechar_secondReward);
    $this->assign('level8_reward_to_rechar',$level8_reward_to_rechar);
    $this->assign('level8_reward_to_shopEta',$level8_reward_to_shopEta);

    $this->assign('level8_rechar2_firstReward',$level8_rechar2_firstReward);
    $this->assign('level8_rechar2_secondReward',$level8_rechar2_secondReward);
    $this->assign('level8_reward2_to_rechar',$level8_reward2_to_rechar);
    $this->assign('level8_reward2_to_shopEta',$level8_reward2_to_shopEta);

    $this->assign('level8_rechar3_firstReward',$level8_rechar3_firstReward);
    $this->assign('level8_rechar3_secondReward',$level8_rechar3_secondReward);
    $this->assign('level8_reward3_to_rechar',$level8_reward3_to_rechar);
    $this->assign('level8_reward3_to_shopEta',$level8_reward3_to_shopEta);

    //九级
    $this->assign('level9_rechar_firstReward',$level9_rechar_firstReward);
    $this->assign('level9_rechar_secondReward',$level9_rechar_secondReward);
    $this->assign('level9_reward_to_rechar',$level9_reward_to_rechar);
    $this->assign('level9_reward_to_shopEta',$level9_reward_to_shopEta);

    $this->assign('level9_rechar2_firstReward',$level9_rechar2_firstReward);
    $this->assign('level9_rechar2_secondReward',$level9_rechar2_secondReward);
    $this->assign('level9_reward2_to_rechar',$level9_reward2_to_rechar);
    $this->assign('level9_reward2_to_shopEta',$level9_reward2_to_shopEta);

    $this->assign('level9_rechar3_firstReward',$level9_rechar3_firstReward);
    $this->assign('level9_rechar3_secondReward',$level9_rechar3_secondReward);
    $this->assign('level9_reward3_to_rechar',$level9_reward3_to_rechar);
    $this->assign('level9_reward3_to_shopEta',$level9_reward3_to_shopEta);
        $this->display("fee");
  ...
  public function recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level2_recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level2_rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level2_rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level2_reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level2_reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level3_recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level3_rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level3_rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level3_reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level3_reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level4_recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level4_rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level4_rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level4_reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level4_reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  //六级奖励设置
  public function level6_recharge_jlcssz(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level6_rechar_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level6_rechar_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level6_reward_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level6_reward_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level6_recharge_jlcssz2(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level6_rechar2_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level6_rechar2_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level6_reward2_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level6_reward2_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level6_recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level6_rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level6_rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level6_reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level6_reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  //七级奖励设置
  public function level7_recharge_jlcssz(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level7_rechar_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level7_rechar_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level7_reward_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level7_reward_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level7_recharge_jlcssz2(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level7_rechar2_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level7_rechar2_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level7_reward2_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level7_reward2_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level7_recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level7_rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level7_rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level7_reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level7_reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  //八级奖励设置
  public function level8_recharge_jlcssz(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level8_rechar_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level8_rechar_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level8_reward_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level8_reward_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level8_recharge_jlcssz2(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level8_rechar2_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level8_rechar2_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level8_reward2_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level8_reward2_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level8_recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level8_rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level8_rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level8_reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level8_reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  //九级奖励设置
  public function level9_recharge_jlcssz(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level9_rechar_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level9_rechar_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level9_reward_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level9_reward_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level9_recharge_jlcssz2(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level9_rechar2_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level9_rechar2_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level9_reward2_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level9_reward2_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
  ...
  public function level9_recharge_jlcssz3(){
      $rechar_firstReward = I('rechar_firstReward');
      $rechar_secondReward = I('rechar_secondReward');
    $reward_to_rechar = I('reward_to_rechar');
    $reward_to_shopEta = I('reward_to_shopEta');
    ...
    $reward_to_rechar = $reward_to_rechar/100;
    $reward_to_shopEta = $reward_to_shopEta/100;
      $res = M('config')->where(array('name'=>'level9_rechar3_firstReward'))->setField('value',$rechar_firstReward);
      $res2 = M('config')->where(array('name'=>'level9_rechar3_secondReward'))->setField('value',$rechar_secondReward);
    $res3 = M('config')->where(array('name'=>'level9_reward3_to_rechar'))->setField('value',$reward_to_rechar);
    $res4 = M('config')->where(array('name'=>'level9_reward3_to_shopEta'))->setField('value',$reward_to_shopEta);
      if($res !== false||$res2 !== false||$res3 !== false||$res4 !== false){
          echo 1;die;
      }else{
          echo 2;die;
    ...
    public function ratio(){
        ...
        $res4 = M('config')->where(array('name'=>'cash2_ratio'))->setField('value',$cash2_ratio);
